...
import { FaUser, FaLock, FaEnvelope, FaPhone, FaHome, FaLeaf, FaArrowRight } from 'react-icons/fa';
...
const CustomerRegister = () => {
  ...
  return (
    <div className="min-h-screen flex">
      {/* Left Side - Branding */}
      <div className="hidden lg:flex lg:w-[40%] bg-gradient-to-br from-lime-600 via-emerald-600 to-emerald-700 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 text-white">
          ...
          <h2 className="text-3xl font-bold mb-4">Join as a Customer</h2>
          <p className="text-emerald-50 text-lg leading-relaxed mb-8">
            Access fresh produce directly from local farmers. Support sustainable agriculture.
          </p>
        ...
        <div className="w-full max-w-lg">
          ...
          <div className="bg-white shadow-lg rounded-2xl p-8">
            <div className="mb-6">
              ...
              <p className="text-gray-600">Start buying fresh produce today</p>
            </div>
